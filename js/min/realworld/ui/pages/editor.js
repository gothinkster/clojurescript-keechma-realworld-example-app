...
var tags = clojure.string.split.cljs$core$IFn$_invoke$arity$2((function (){var or__11514__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(form_state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data,cljs.core.cst$kw$tags], null));
...
var form_id = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$editor,(function (){var or__11514__auto__ = cljs.core.cst$kw$subpage.cljs$core$IFn$_invoke$arity$1(keechma.toolbox.ui.route_GT_(ctx));
if(cljs.core.truth_(or__11514__auto__)){
return or__11514__auto__;
} else {
...
var form_state = cljs.core.deref(keechma.toolbox.forms.helpers.form_state(ctx,form_id));
