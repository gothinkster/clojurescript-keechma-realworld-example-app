...
realworld.ui.components.header.render_nav_item = (function realworld$ui$components$header$render_nav_item(ctx,p__26622){
var map__26625 = p__26622;
var map__26625__$1 = ((((!((map__26625 == null)))?((((map__26625.cljs$lang$protocol_mask$partition0$ & (64))) || (map__26625.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26625):map__26625);
var route = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26625__$1,cljs.core.cst$kw$route);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26625__$1,cljs.core.cst$kw$title);
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26625__$1,cljs.core.cst$kw$icon);
var current_page = cljs.core.cst$kw$page.cljs$core$IFn$_invoke$arity$1(keechma.toolbox.ui.route_GT_(ctx));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li$nav_DASH_item,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,title], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a$nav_DASH_link,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$href,keechma.ui_component.url(ctx,route),cljs.core.cst$kw$class,keechma.toolbox.util.class_names(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$active,cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(current_page,cljs.core.cst$kw$page.cljs$core$IFn$_invoke$arity$1(route))], null))], null),(cljs.core.truth_(icon)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$i,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,icon], null)], null):null),(cljs.core.truth_(icon)?[cljs.core.str(" "),cljs.core.str(title)].join(''):title)], null)], null);
});
...
return realworld.ui.components.header.render_nav_item(ctx,p1__26627_SHARP_);
